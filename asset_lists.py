...
smart_contract_platforms_coingecko = ['ethereum', 'bitcoin', 'solana', 'terra-luna-2', 'canto',
                                      'avalanche-2', 'cosmos', 'fantom', 'mina-protocol', 'internet-computer',
                                      'eos', 'tezos', 'cardano', 'polkadot', 'near', 'tron', 'algorand',
                                      'neo', 'zilliqa', 'oasis-network', 'harmony', 'kusama', 'binancecoin',
                                      'aptos']
...
# cross-chain
cross_chain_coingecko = ['thorchain', 'celer-network', 'republic-protocol', 'stargate-finance', 'synapse-2', 'axelar']

# layer-2
layer_2_coingecko = ['matic-network', 'optimism']
